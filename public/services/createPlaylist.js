...
function createPlaylist(playlist_name="New Playlist by Spotify Rewind", public=false, collaborative=false, description='') {
    ...
    if (error) {
      ...
      if (access_token) {
        ...
        $.ajax({
            ...
            error: function() {
              window.location.href = 'Playlist generation is not available at this time.\nPlease try again later.';
            }
        });
      } else {
